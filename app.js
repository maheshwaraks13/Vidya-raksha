...
const pageTitles = {
  ...
  alerts:'SMS Alert Log', schemes:'Government Schemes', upload:'Upload Data', about:'About This Project'
};
...
function showPage(id) {
  ...
  const map = ['dashboard','students','predict','alerts','schemes','upload','about'];
